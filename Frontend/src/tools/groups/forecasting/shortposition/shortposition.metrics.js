...
export const getShortPositionMetrics = ({ drawing, chart, series, candles = [], activeToolConfig = {} }) => {
    ...
    // For short: stop loss above entry (smaller y), take profit below entry (larger y)
    ...
    const bottom = Math.max(tpY, entryY);
    ...
    return {
        ...
        tpPrice,
        slPrice,
        tpOffsetPx: finalTpOffsetPx,
        slOffsetPx: finalSlOffsetPx,
    };
};

export default {
    getShortPositionMetrics,
};
